...
Public Class Main
    ...
    Private WithEvents Speed As New Timer
    Private Grid As New Grid(Me) With {.Size = New Size(Grid.x * Tile.x + 2, Grid.y * Tile.y + 2), .BorderStyle = BorderStyle.FixedSingle}
    Public Preview As New Grid(Me) With {.Size = New Size(5 * Tile.x, 4 * Tile.y), .Dock = DockStyle.Right}
    Public Sub New()
        Me.Text = Title
...
Public Class Grid
    ...
    Public Sub NewShape()
        ...
        'Get Color
        Me.ColorIndex += 1
        If Me.ColorIndex = Colors.Count Then
            Me.ColorIndex = 0
        End If
        Dim PreviewColor = Me.ColorIndex + 1
        If PreviewColor = Colors.Count Then
            PreviewColor = 0
        End If
        ...
        Dim PreviewShape = New Shape(Me.Form.Preview, Colors(PreviewColor), Me.NextShape)
        For Each Tile In PreviewShape.Tiles
            Tile.Left -= 2 * Tile.x
            Tile.Top += 1 * Tile.y
        Next
    ...
    Public Sub RemoveCompletedLines()
        Do
            ...
            For TileTop = y * Tile.y To 0 Step -Tile.y
                RemoveList.Clear()
                For TileLeft = 0 To x * Tile.x Step Tile.x
...
Public Class Shape
    ...
    Public Sub New(Grid As Grid, Color As Color, Style As Styles)
        ...
        Select Case Me.Style
            ...
            Case Styles.T
                For PositionY = 0 To 1
                    For PositionX = 3 To 5
...
Public Class Tile
    ...
    End Sub
    Public Function CanMove(x As Integer, y As Integer) As Boolean
        Dim Location = New Point(Me.Left + x * Tile.x, Me.Top + y * Tile.y)
